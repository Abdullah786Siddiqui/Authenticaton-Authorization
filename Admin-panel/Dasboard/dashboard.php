...
<div class="d-flex" style="min-height: 100vh;">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; min-height: 100vh;"> <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg class="bi pe-none me-2" width="40" height="32" aria-hidden="true">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item"> <a href="../Dasboard/products/Products.php"  class="nav-link text-white cursor " aria-current="page"> <svg class="bi pe-none me-2" width="16" height="16" aria-hidden="true">
            <use xlink:href="#home"></use>
          </svg>
          Products
        </a> </li>
      <li class="nav-item"> <a href="../Dasboard/Users/users.php" class="nav-link text-white cursor" aria-current="page"> <svg class="bi pe-none me-2" width="16" height="16" aria-hidden="true">
            <use xlink:href="#home"></use>
          </svg>
          Users
        </a> </li>
